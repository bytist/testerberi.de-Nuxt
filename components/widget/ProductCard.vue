<template>
  <NuxtLink v-if="item" :to="'/produkte/' + item.link">
    <div
    ...
    >
      <div class="flex flex-col justify-between items-center">
        ...
        <div class="detail-wrapper h-auto w-full">
          ...
          <ul
            class="text-tb-primary-dark list-disc list-inside prod-card-chk-list mb-1"
          >
            <!-- <li>
              <span>Farbe: {{ item.color }}</span>
            </li> -->
            <li v-for="(value, id) in item.datenblatt" :key=id>
            ...
            <!-- <li>
              <span>
                {{ item.size }} cm, {{ Math.floor(item.size / 2.54) }} Zoll
              </span>
            </li>
            <li>
              <span>
                {{ item.width.toLocaleString() }} x
                {{ item.height.toLocaleString() }} Pixel
              </span>
            </li>
            <li>
              <span
          ...
          <div class="p-2 xl:p-4 h-full">
            ...
            <div>
              ...
              >
                ...
                <rect x="0" y="124" rx="4" ry="4" height="46" class="w-full" />
                <rect x="0" y="180" rx="4" ry="4" height="46" class="w-full" />
                <rect x="0" y="236" rx="4" ry="4" height="46" class="w-full" />
              </ContentLoader>
            </div>
